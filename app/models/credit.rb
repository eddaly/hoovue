class Credit < ActiveRecord::Base
  attr_accessible :product_id, :user_id, :role, :credit_validations_count, :role_desc, :current_credit_role, :confirmed_validations_count, :credit_validation_id, :issue, :validator_id, :user_name, :current_credit_id, :fact, :credit_validations_attributes, :status, :pending_user_email, :count, :startdate, :enddate, :release, :category, :product_idd, :tag_list
