class CreditValidation < ActiveRecord::Base
  attr_accessible :credit_id, :user_id, :user_validation, :oneside, :token, :credit_validation_count, :token_created_at, :token_sent_at, :verified, :validator_id, :status, :current_credit_id  
