class Product < ActiveRecord::Base
  attr_accessible :description, :genre, :image, :studio, :title, :year, :status, :user_id, :credits_attributes, :properties, :product_genre_id, :role, :role_description, :fact, :issue, :url, :remove_image, :image_cache
